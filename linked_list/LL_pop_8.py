...
#  basically poping in list means we need to keep 2 edge cases in mind one is what if the list is empty and what if list has only one node
#  below is the example which will give you user test cases and how the flow goes
#  above one is simple example if you do not understand
#  run the below code 
#  popping is basically we need to point tail to previous node and the after pointing to previous node update its next value to None
